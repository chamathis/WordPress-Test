...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">        
        ...
        <?php 
            echo "Ticket Price - ".get_post_meta( get_the_ID(), $key = 'film_ticket_price', $single = true )." | ";
                echo "Release Date - ".get_post_meta( get_the_ID(), $key = 'film_release_date', $single = true );
        ?>
